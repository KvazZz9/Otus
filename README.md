...
С помощью роли ansible:
    ...
    Прописываем в hosts dns записи всех узлов
    ...
    Создаем базу kvaz_study для последующего использования только на mysql1 с которого в последствие будем собирать кластер.
